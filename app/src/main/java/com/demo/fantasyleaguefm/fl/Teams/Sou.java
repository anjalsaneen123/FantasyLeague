...
public class Sou extends AppCompatActivity {
...
//            Log.d("RESULT:",result);
            try
            {
                ...
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/7360/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/44018/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/68503/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/70154/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/67541/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/12719/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/513840/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/861289/event/"+current+"/picks");
...
//            Log.d("RESULT:",result);
            try
            {
                ...
                stt++;
                if(stt==8){
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/7360");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/44018");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/68503");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/70154");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/67541");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/12719");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/513840");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/861289");
                }
