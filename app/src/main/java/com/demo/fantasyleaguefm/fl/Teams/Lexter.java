...
public class Lexter extends AppCompatActivity {
...
//            Log.d("RESULT:",result);
            try
            {
                ...
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/17211/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/61622/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/8816/event/"+current+"/picks");
...
//            Log.d("RESULT:",result);
            try
            {
                ...
                if(stt==8){
                    ...
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/8816");
                }
