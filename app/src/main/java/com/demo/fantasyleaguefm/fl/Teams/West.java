...
//            Log.d("RESULT:",result);
            try
            {
                ...
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/997624/event/"+current+"/picks");
...
//            Log.d("RESULT:",result);
            try
            {
                ...
                if(stt==8){
                    ...
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/997624");
                }
