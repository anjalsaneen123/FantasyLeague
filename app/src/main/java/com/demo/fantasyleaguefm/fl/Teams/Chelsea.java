...
public class Chelsea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Chelsea");


        new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/1454");
        new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/348215");
        new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/7500");
        new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/24146");
        new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/600421");
        new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/280");
        new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/264486");
        new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/1062");
