...
//            Log.d("RESULT:",result);
            try
            {
                ...
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/449/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/102/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/558/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/118/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/44977/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/41111/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/2101/event/"+current+"/picks");
                new HttpAsyncTaskHit().execute("https://fantasy.premierleague.com/drf/entry/654/event/"+current+"/picks");
...
//            Log.d("RESULT:",result);
            try
            {
                ...
                stt++;
                if(stt==8){
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/449");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/102");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/558");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/118");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/44977");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/41111");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/2101");
                    new HttpAsyncTask().execute("https://fantasy.premierleague.com/drf/entry/654");
                }
